            ...
            <AnimatePresence>
                {menuOpened && 
                    <motion.nav 
                            ...
                            className={`md:${menuOpen} sm:${menuOpen} gap-10 text-2xl flex flex-col top-0 left-0 fixed justify-center items-center top-0 left-0 w-full h-[100vh] z-[9] xl:hidden lg:hidden`}
                        ...
                        <div  className={`flex flex-col gap-6 justify-center items-center w-full ${servicesVisible}`}>
                            ...
                            <Link className='hover:scale-105 text-center text-white text-lg' href="/services/portrait-evenementiel" onClick={handleLinkClick} aria-label="Lien vers la page portrait événementiel">Grossesse</Link>
                            <Link className='hover:scale-105 text-center text-white text-lg' href="/services/portrait-intimiste" onClick={handleLinkClick} aria-label="Lien vers la page portrait intimiste">Bébé</Link>
