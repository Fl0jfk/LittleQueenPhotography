...
function Navbar({menuOpened, onLinkClick} :NavbarProps ){
    ...
    return (
        <>
                ...
                {menuOpened && 
                    <motion.nav 
                        ...
                        <div className='w-2/12 h-[10vh] flex items-center justify-center w-full'>
                            {Logo && 
                                <Link className='hover:scale-110 flex items-center justify-center' href="/" onClick={handleLinkClick} aria-label="Link to top">
                                    <Image src={Logo} alt='Logo de PhotoDroner76' width={120} height={120} className='cursor-pointer z-[8]'/>
                                </Link>
                            }
                        </div>
                        ...
                        <div  className={`flex flex-col gap-8 justify-center items-center w-full ${servicesVisible}`}>
                            ...
                            <Link className='hover:scale-105 text-center text-white' href="/services/portrait-intimiste" onClick={handleLinkClick} aria-label="Lien vers la page portrait intimiste">Boudoir intimiste</Link>
                            <Link className='hover:scale-105 text-center text-white' href="/services/portrait-emotionnel" onClick={handleLinkClick} aria-label="Lien vers la page portrait émotionnel">Boudoir & texture</Link>
                            <Link className='hover:scale-105 text-center text-white' href="/services/portrait-evenementiel" onClick={handleLinkClick} aria-label="Lien vers la page portrait événementiel">Artistique</Link>
                            <Link className='hover:scale-105 text-center text-white' href="/services/portrait-intimiste" onClick={handleLinkClick} aria-label="Lien vers la page portrait intimiste">Portrait</Link>
                            <Link className='hover:scale-105 text-center text-white' href="/services/portrait-emotionnel" onClick={handleLinkClick} aria-label="Lien vers la page portrait émotionnel">Extérieur</Link>
                            <Link className='hover:scale-105 text-center text-white' href="/services/portrait-evenementiel" onClick={handleLinkClick} aria-label="Lien vers la page portrait événementiel">Grossesse & bébé</Link>
                            <Link className='hover:scale-105 text-center text-white' href="/services/portrait-emotionnel" onClick={handleLinkClick} aria-label="Lien vers la page portrait émotionnel">Moments de vie</Link>                           
                        </div>
            ...
            <nav style={{background: `${bgMenuOpen}`}} className={`flex gap-6 xl:mr-8 lg:mr-8 sm:hidden md:hidden z-[9]`}>
                <Link className='hover:scale-110 text-white hover:opacity-70' href="/" aria-label="Lien vers la page d'accueil">Accueil</Link>
                <Link className='hover:scale-110 text-white hover:opacity-70' href="/services" aria-label="Lien vers la page mes services">Mes services</Link>
                <Link className='hover:scale-110 text-white hover:opacity-70' href="/portfolio" aria-label="Lien vers la page portfolio">Portfolio</Link>
                <Link className='hover:scale-110 text-white hover:opacity-70' href="/about" aria-label="Lien vers la page à propos">À propos</Link>
                <Link className='hover:scale-110 text-white hover:opacity-70' href="/contact" aria-label="Lien vers la page contact">Contact</Link>
            </nav>
        </>
    )
}
