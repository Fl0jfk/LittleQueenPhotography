...
export default function Footer (){
    return (
        <footer className="w-full h-full p-2 flex flex-col gap-4">
            <InstaFeed/>
            <div className="flex w-3/4 mx-auto justify-between sm:flex-col sm:gap-6 text-center">
                <Link href={"/"} className="rounded uppercase text-2xl border-2 text-white p-6 hover:bg-[#6f3d47]">Mes prestations</Link>
                <Link href={"/"} className="rounded uppercase text-2xl border-2 text-white p-6 hover:bg-[#6f3d47]">Contactez-moi</Link>
            </div>
            <div className="flex w-1/5 mx-auto justify-between sm:w-3/5 mt-4">
                <Link href="/" className="hover:scale-[1.1]" target="blank">
            ...
            <Link href={"/mentionslegales"} className="text-white uppercase self-center text-xl">Mentions légales</Link>
